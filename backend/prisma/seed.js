...
async function main() {
    ...
    // ---------- Users ----------
    const users = [
        { email: 'admin@indigo.dev', name: 'Admin', password: 'Admin@123', role: client_1.Role.ADMIN },
        { email: 'staff@indigo.dev', name: 'Staff', password: 'Staff@123', role: client_1.Role.STAFF },
        { email: 'designer@indigo.dev', name: 'Designer', password: 'Design@123', role: client_1.Role.DESIGNER },
        { email: 'warehouse@indigo.dev', name: 'Warehouse', password: 'Ware@123', role: client_1.Role.WAREHOUSE },
        { email: 'customer@indigo.dev', name: 'Jane Customer', password: 'Cust@123', role: client_1.Role.CUSTOMER },
    ];
